...
object HomeworkSpec {
  implicit val decodeLocalDate: Decoder[LocalDate] = Decoder.decodeString
    .emapTry(dateString => Try(LocalDate.parse(dateString, DateTimeFormatter.ofPattern("yyyyMMdd"))))

  implicit val config: Configuration = Configuration.default

  @ConfiguredJsonCodec final case class TeamTotals(assists: String,
